  ...
  return (
    <span className={`inline-flex items-center gap-1.5 ${className}`}>
      <a
        ...
        className="font-mono text-bird-600 hover:text-bird-800 underline"
      >
        {display}
      </a>
      <button
        type="button"
        onClick={handleCopy}
        className="text-slate-400 hover:text-bird-600 p-0.5 rounded focus:outline-none focus:ring-2 focus:ring-bird-300"
        title="Copy address"
      >
        {copied ? (
