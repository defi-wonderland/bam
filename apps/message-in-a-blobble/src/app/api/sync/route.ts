 ...
 * `BlobBatchRegistered` logs by the indexed `contentTag` topic. Only
 * batches whose tag equals `MESSAGE_IN_A_BLOBBLE_TAG` are returned —
 * the single-filter-recovery primitive that the ERC amendment unlocks.
 */
