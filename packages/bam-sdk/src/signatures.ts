...
// Re-export so consumers that imported from `signatures.js` keep working.
export { EIP712_DOMAIN_NAME, EIP712_DOMAIN_VERSION, EIP712_TYPES, computeECDSADigest };
...
//
// EIP-712 domain + typed-data primitives moved to ./eip712.ts so that
// browser bundles importing only those symbols don't pull in the
// @noble curves below. Re-exported above to preserve the historical
// import path.
// ═════════════════════════════════════════════════════════════════════════
