...
The core registration interface extends [ERC-BSS](./eip-8179.md) (Blob Space Segments) with a
...
blobs with other protocols, callers needed a separate [ERC-BSS](./eip-8179.md) call to declare their
...
[ERC-3722](./eip-3722.md) (Poster) and [ERC-BSS](./eip-8179.md): the event log suffices for
