...
A reference implementation of the recommended ABI-encoded shape lives in this repository at
[`packages/bam-contracts/src/decoders/ABIDecoder.sol`](../../packages/bam-contracts/src/decoders/ABIDecoder.sol).
Its payload is `abi.encode(Message[] messages, bytes signatureData)`. It is deployed on Sepolia
at [`0x3a1bB111079cBaF4CAc320545Bfd1f6A92250425`](https://sepolia.etherscan.io/address/0x3a1bB111079cBaF4CAc320545Bfd1f6A92250425)
(verified bytecode); downstream implementers can sanity-check their own decoders against this
deployed instance.
